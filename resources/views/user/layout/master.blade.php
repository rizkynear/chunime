                    ...
                    <div class="header__nav">
                        <nav class="header__menu mobile-menu">
                            <ul>
                                ...
                                <li><a href="{{ route('user.anime.ongoing') }}">Ongoing List</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
    ...
    <div class="search-model">
        <div class="h-100 d-flex align-items-center justify-content-center">
            ...
            <form class="search-model-form" action="{{ route('user.search') }}">
                <input type="text" id="search-input" name="keyword" placeholder="Cari judul anime" value="{{ request()->get('keyword') }}">
            </form>
        </div>
    </div>
    <!-- Search model end -->
